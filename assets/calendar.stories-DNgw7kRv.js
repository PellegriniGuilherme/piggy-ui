import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{C as o}from"./calendar-BvsvqIka.js";import{r as m}from"./index-DQLiH3RP.js";import"./utils-DjqsqOe8.js";import"./button-BZd6qCJT.js";import"./index-2DKqFS1n.js";import"./index-3UDGtr2f.js";import"./chevron-right-BDO-kwJq.js";import"./createLucideIcon-DvezSUYd.js";import"./chevron-left-9zvuctnJ.js";const k={title:"PiggyUI/Components/Calendar",component:o,tags:["autodocs"],argTypes:{mode:{control:"select",options:["single","multiple","range"]},selected:{control:!1},onSelect:{action:"onSelect"}}},M=({mode:t,...l})=>{const[S,x]=m.useState(new Date),[j,C]=m.useState([new Date,new Date(new Date().setDate(new Date().getDate()-1))]),[R,E]=m.useState({from:new Date(new Date().setDate(new Date().getDate()-3)),to:new Date});return t==="range"?s.jsx(o,{...l,mode:"range",selected:R,onSelect:e=>{E(e)}}):t==="multiple"?s.jsx(o,{...l,mode:"multiple",selected:j,onSelect:e=>{C(e)}}):s.jsx(o,{...l,mode:"single",selected:S,onSelect:e=>{x(e)}})},a={render:t=>s.jsx(M,{...t}),args:{mode:"single"}},n={args:{mode:"range",selected:{from:new Date(new Date().setDate(new Date().getDate()-3)),to:new Date}}},r={args:{mode:"multiple",selected:[new Date,new Date(new Date().setDate(new Date().getDate()-1))]}};var c,p,D;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
